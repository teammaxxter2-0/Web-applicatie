...
function AdminSeeOffertes() {
  ...
  const accepteer = async (id: number) => {
    try {
      ...
      if (response.ok) {
        ...
        setSelectedOption((prev) => ({ ...prev, accepted: true }));
      } else {
  ...
  const columns: TableColumnsType<Offerte> = [
    ...
    },
    {
      ...
      sorter: (a, b) => a.offerte_prijs_totaal - b.offerte_prijs_totaal,
    ...
    },
    {
      ...
      render: (record) => (
        <Space size="middle">
          <Button type="link" onClick={() => handleDetails(record)}> <InfoCircleOutlined /></Button>
        </Space>
      ),
    },
  ];
        ...
        <div>
          ...
          <Flex gap="middle" justify='center' >
            <Button
              ...
              size="large"
              onClick={() => GeneratePDF(selectedOption)}
            >
              Genereer PDF
            </Button>
            ...
            {!selectedOption.accepted && (
              <Button
                ...
                size="large"
                style={{ width: '200px' }}
                onClick={() => accepteer(selectedOption.id)}
              >
                Accepteer Offerte
              </Button>
